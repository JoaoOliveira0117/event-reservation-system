...
<body>
        ...
        <form id="event-form">
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-control" required>
                    <option value="event_pending">Pending</option>
                    <option value="event_full">Full</option>
                    <option value="event_finished">Finished</option>
                </select>   
    ...
    @vite('resources/js/updateEventPage.js')
</body>
</html>
